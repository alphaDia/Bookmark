...
SECRET_KEY = 'django-insecure-w^n5$vn9w#6e0md^unj9h!=xade=zg$4ov(1)p$2k9h17ulb(i'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True if config.get('DEBUG') == 'on' else False
...
SOCIAL_AUTH_TWITTER_KEY = config.get('SOCIAL_AUTH_TWITTER_KEY')
SOCIAL_AUTH_TWITTER_SECRET = config.get('SOCIAL_AUTH_TWITTER_SECRET')
